...
- [WIP] 🔥 **Add 20 more ingredients** - Expand ingredient variety in `src/data/ingredients.json`. Include legendary/exotic types. Organize by rarity tiers. (~100 lines JSON)

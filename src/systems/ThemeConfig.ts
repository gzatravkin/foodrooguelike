...
export const ThemeConfigs: Record<Theme, { colors: ThemeColors; generation: ThemeGenerationConfig }> = {
  forest: {
    ...
    generation: {
      ...
      hazardDensity: 0.5,
      interactiveTiles: ['health_fountain', 'wishing_well', 'treasure_chest', 'campfire', 'berry_bush', 'herb_plant', 'mushroom_patch', 'ancient_tree'],
  ...
  cave: {
    ...
    generation: {
      ...
      hazardDensity: 0.3,
      interactiveTiles: ['statue', 'treasure_chest', 'shrine', 'spike_trap', 'mushroom_patch', 'crystal_formation'],
      interactiveDensity: 0.45,
      openness: 0.6,
      connectivity: 0.4,
    },
  },
  ruins: {
    ...
    generation: {
      ...
      hazardDensity: 0.4,
      interactiveTiles: ['shrine', 'statue', 'treasure_chest', 'spike_trap', 'poison_trap', 'herb_plant', 'ancient_tree'],
      interactiveDensity: 0.5,
      openness: 0.5,
      connectivity: 0.5,
    },
  ...
  dungeon: {
    ...
    generation: {
      ...
      hazardTiles: [],
      hazardDensity: 0.2,
      interactiveTiles: ['treasure_chest', 'shrine', 'spike_trap', 'poison_trap', 'mysterious_door', 'herb_plant', 'mushroom_patch'],
      interactiveDensity: 0.55,
      openness: 0.4,
      connectivity: 0.3,
    },
  },
  ice: {
    ...
    generation: {
      ...
      hazardDensity: 0.7,
      interactiveTiles: ['magic_circle', 'statue', 'shrine', 'treasure_chest', 'crystal_formation'],
  ...
  lava: {
    ...
    generation: {
      ...
      hazardTiles: ['lava'],
      hazardDensity: 0.5,
      interactiveTiles: ['shrine', 'treasure_chest', 'magic_circle', 'spike_trap', 'fire_plant'],
      interactiveDensity: 0.45,
      openness: 0.6,
      connectivity: 0.6,
    },
  ...
  void: {
    ...
    generation: {
      ...
      hazardDensity: 0.6,
      interactiveTiles: ['magic_circle', 'shrine', 'treasure_chest', 'teleporter', 'mysterious_door', 'void_plant'],
      interactiveDensity: 0.55,
      openness: 0.7,
      connectivity: 0.8,
    },
